...
export type PlayerWhereInput = {
  ...
  scoreSeconds?: Prisma.IntFilter<"Player"> | number
}

export type PlayerOrderByWithRelationInput = {
  name?: Prisma.SortOrder
  scoreSeconds?: Prisma.SortOrder
}
...
export type PlayerScalarWhereWithAggregatesInput = {
  ...
  scoreSeconds?: Prisma.IntWithAggregatesFilter<"Player"> | number
}
...
export type PlayerUpdateInput = {
  ...
  scoreSeconds?: Prisma.IntFieldUpdateOperationsInput | number
}
...
export type PlayerOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"name" | "scoreSeconds", ExtArgs["result"]["player"]>
...
export interface PlayerDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const playerWithNameOnly = await prisma.player.findMany({ select: { name: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Players and only return the `name`
   * const playerWithNameOnly = await prisma.player.createManyAndReturn({
   *   select: { name: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Players and only return the `name`
   * const playerWithNameOnly = await prisma.player.updateManyAndReturn({
   *   select: { name: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PlayerFieldRefs {
  ...
  readonly scoreSeconds: Prisma.FieldRef<"Player", 'Int'>
}
